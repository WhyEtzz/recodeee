...
const start = (geps = new Client()) => {
    ...
    console.log(color(figlet.textSync(' SELF BOT', 'Larry 3D'), 'cyan'))
    console.log(color(figlet.textSync('------------', 'Larry 3D'), 'green'))
    ...
    console.log(color('[ZAM]', 'cyan'), color('HNZM is online now!', 'green'))
    console.log(color('[DEV]', 'cyan'), color('Welcome back, ZAM! Hope you are doing well~', 'green'))
    ...
    geps.onAnyMessage((message) => {
        geps.getAmountOfLoadedMessages()
            .then((msg) => {
                if (msg >= 1000) {
                    console.log(color('[ZAM]', 'cyan'), color(`Loaded message reach ${msg}, cuting message cache...`, 'green'))
                    //console.log('[Nabil]', color(`Loaded message reach ${msg}, cuting message cache...`, 'yellow'))
                    geps.cutMsgCache()
                    console.log(color('[ZAM]', 'cyan'), color('Success Cache deleted!', 'green'))
                    //console.log('[Nabil]', color('Cache deleted!', 'yellow'))
                }
            })
    ...
    geps.onAnyGlobalParicipantsChanged(async (event) => {
