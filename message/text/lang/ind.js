...
exports.wait = () => {
    return `*_Tunggu sebentar akan kami proses dan nggak akan lama seperti dia_*`
}
...
exports.blomdaftar = () => {
    return `Kamu belum terdaftar sebagai teman I X A silahkan kirim ${prefix}verify untuk mendaftar`
}
...
╭──「 *IKLAN* 」────
│───────────────────────────
│ *BERIKUT INI IKLAN I X A*
│───────────────────────────
│*DAFTAR SATUAN SEWA & BUAT BOT :*
│
│> *SEWA : 10K/GRUP (BULAN)*
│> *BUAT : 50K (BISA JADI OWNER)*
│> *ADMINBOT : 5K/BULAN (COMMAND ADMINBOT)*
│> *ADMINBAN : 5K/BULAN (COMMAND ADMINBAN)*
│> *VIP : 10K/BULAN (COMMAND VIP)*
│
│*DAFTAR PAKET SEWA & BUAT BOT :*
│
│> *BUAT : 50K/BULAN (BISA JADI OWNER)*
│> *BUAT + UPDATE : 75K/BULAN (BISA JADI OWNER)*
│> *SEWA + ADMINBAN : 15K/BULAN (GROUP+ADMINBAN)*
│> *SEWA + ADMINBOT : 15K/BULAN (GROUP+ADMINBOT)*
│> *SEWA + VIP : 20K/BULAN (GROUP+VIP)*
│> *SEWA + ADMINBAN + ADMINBOT : 20K/BULAN*
│> *SEWA + ADMINBAN + VIP : 25K/BULAN*
│> *SEWA + ADMINBOT + VIP : 25K/BULAN*
│> *SEWA + VIP PLUSS : 30K/BULAN*
│
│> *PEMBAYARAN BISA MELALUI :*
│> *OVO, GOPAY, DANA, PULSA +5K KENA RATE SOALNYA!*
│───────────────────────────
│> *KEUNTUNGAN SEWA BOT :*
│> *1. BISA MENJADI ADMIN I X A*
│> *2. BISA MENDAPATKAN COMMAND ADMIN*
│> *KEUNTUNGAN VIP ADM BOT :*
...
exports.snk = () => {
    return `Syarat dan Ketentuan Bot I X A
...
Donasi bisa melalui
Pulsa/Gopay : 0858-9561-8295
Terima kasih yang sudah mau donasi...
└ hasil donasi akan digunakan penambahan biaya server(Rdp)
...
exports.ingfoautoclose = () => {
    return`
Contoh format untuk autoclose/open group
yaitu :

${prefix}autoclose 10s
${prefix}autoclose 10m
${prefix}autoclose 10h
